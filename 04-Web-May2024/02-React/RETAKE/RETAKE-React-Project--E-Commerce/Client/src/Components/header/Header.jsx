...
export default function Header() {
    // Add state for category menu toggle
    const [isCateToggleOpen, setIsCateToggleOpen] = useState(false);

    // Toggle handler function
    const handleCateToggle = () => {
        setIsCateToggleOpen(!isCateToggleOpen);
    };
                        ...
                        <div className="custom-category_col col-12">
                            <div className="category-menu category-menu-hidden">
                                <div className="category-heading">
                                    <h2 className="categories-toggle" onClick={handleCateToggle}>
                                        <span>Shop By</span>
                                        <span>Department</span>
                                    </h2>
                                </div>
                                <div id="cate-toggle" className={`category-menu-list ${isCateToggleOpen ? 'open' : ''}`}>
                                    <ul>
