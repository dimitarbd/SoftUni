                    ...
                    <div className="hm-form_area">
                        <form action="#" className="hm-searchbox">
                            <select className="nice-select select-search-category">
                                ...
                                <option value="">Blouses</option>
                                <option value="">Sanai</option>
                                <option value="">Hard Drives</option>
                                <option value="">Graphic Cards</option>
                                <option value="">Processors (CPU)</option>
                                <option value="">Memory</option>
                                <option value="">Motherboards</option>
                                <option value="">Fans &amp; Cooling</option>
                                <option value="">CD/DVD Drives</option>
                                <option value="">Meito</option>
                                <option value="">Sound Cards</option>
                                <option value="">Cases &amp; Towers</option>
                                <option value="">Casual Dresses</option>
                                <option value="">Evening Dresses</option>
                                <option value="">T-shirts</option>
                                ...
                                <option value="">7.0 Screen</option>
                                <option value="">9.0 Screen</option>
                                <option value="">Bags &amp; Cases</option>
                                <option value="">XailStation</option>
                                <option value="">Batteries</option>
                                <option value="">Microphones</option>
                                <option value="">Stabilizers</option>
                                <option value="">Video Tapes</option>
                                <option value="">Memory Card Readers</option>
